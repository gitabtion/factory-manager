...
public class CreateOrderActivity extends ToolBarActivity {
    ...
    private String timeLast = " 00:00:00";
    ...
    private void bindData() {
        ...
        createOrderRequest.setEndTime(txtOrderEndTime.getText().toString().trim() + timeLast);
        createOrderRequest.setStartTime(txtOrderStartTime.getText().toString().trim() + timeLast);
    ...
    private void createOrder() {
        ...
        RestClient.getService().createOrder(createOrderRequest).enqueue(new DataCallback<APIResponse<CreateOrderResponse>>() {
            ...
            public void onDataResponse(Call<APIResponse<CreateOrderResponse>> call,
                ...
                bundle.putSerializable(CREATE_ORDER,orderModel);
